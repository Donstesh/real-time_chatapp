...
return [
    ...
    /*
     * Here are the collectors that gather metrics
     */
    'collectors' => [
        Spatie\Prometheus\Collectors\RequestDurationCollector::class,
        Spatie\Prometheus\Collectors\RequestCountCollector::class,
        Spatie\Prometheus\Collectors\ResponseCountCollector::class,
        Spatie\Prometheus\Collectors\DatabaseQueryCollector::class,
        Spatie\Prometheus\Collectors\JobCollector::class,
        Spatie\Prometheus\Collectors\CacheCollector::class,
    ],
    'driver' => Spatie\Prometheus\Drivers\RedisDriver::class,
];
